        ...
        <Card className="max-w-md text-center">
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground mb-6">
              We're currently working on integrating our payment gateway. Your
              course enrollment has been recorded and you'll be notified once
              ...
              <Card className="sticky top-24" data-testid="order-summary">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="border-t pt-4 space-y-3">
                    ...
                    <div
                      className="flex justify-between font-bold text-lg border-t pt-3"
